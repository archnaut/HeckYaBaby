...
{
    public class HeckYaBabyInitializer : DropCreateDatabaseAlways<HeckYaBabyContext>
    {
        protected override void Seed(HeckYaBabyContext context)
        {
            context.Profiles.AddRange(new List<ProfileEntity> {
                new ProfileEntity {
                    Name = "Travis, Hayfa M.",
